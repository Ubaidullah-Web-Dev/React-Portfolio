    ...
    return (
        <footer className="bg-white dark:bg-zinc-900 text-gray-700 dark:text-gray-400 py-16 md:py-20 transition-colors duration-300">
            ...
            <div
                data-aos="fade-right"
                data-aos-delay="350"
                className="container mx-auto px-6 mt-16 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 dark:text-gray-400">
