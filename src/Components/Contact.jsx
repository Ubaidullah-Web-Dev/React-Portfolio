        ...
        >
            ...
            >
                <form
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="bg-zinc-800/80 border border-gray-700 hover:border-pink-600 transition-all duration-500 rounded-2xl p-8 shadow-2xl backdrop-blur-md space-y-6"
                >
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-3 rounded-lg bg-zinc-900/80 border border-zinc-700 focus:outline-none focus:border-pink-500 text-gray-200 placeholder-gray-500 transition-all duration-300"
                        />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold mb-2 text-pink-400">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 rounded-lg bg-zinc-900/80 border border-zinc-700 focus:outline-none focus:border-pink-500 text-gray-200 placeholder-gray-500 transition-all duration-300 resize-none"
                        ></textarea>
                    </div>
                    <div className="flex justify-center pt-4">
                        <button
                            ...
                            data-aos="zoom-in"
                            data-aos-delay="300"
                            className="relative bg-pink-600 px-10 py-3 rounded-full font-semibold text-white overflow-hidden group transition-all duration-300 hover:shadow-[0_0_25px_rgba(236,72,153,0.6)]"
                        >
