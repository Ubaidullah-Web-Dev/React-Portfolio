...
function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-screen z-50 transition-all duration-500 ${isScrolled ? "backdrop-blur-lg bg-black/60 shadow-lg" : "bg-transparent"
        }`}
    >
      <div className="max-w-7xl mx-auto w-full overflow-hidden flex items-center justify-between py-4 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-3 shrink-0">
          <Link to="/" className="flex group">
            <svg
              ...
              viewBox="0 0 250 60"
              className="w-40 sm:w-48 md:w-56 h-auto transition-all duration-500 group-hover:scale-110 drop-shadow-[0_0_10px_rgba(255,0,200,0.5)] group-hover:drop-shadow-[0_0_20px_rgba(255,0,200,0.9)]"
            >
              <defs>
        ...
        <div className="hidden md:flex items-center space-x-3 shrink-0">
          <a
            ...
            className="relative p-2 flex items-center justify-center overflow-hidden bg-gray-800 rounded-full group"
          >
            ...
            <FaGithub className="relative text-gray-400 text-lg transition-all duration-300 group-hover:text-white group-hover:scale-125" />
          </a>
          <a
            href="https://www.linkedin.com/in/ubaidullah-sajid-21792a383/"
            className="relative p-2 flex items-center justify-center overflow-hidden rounded-full bg-gray-800 group"
          >
            <span className="absolute inset-0 rounded-full bg-pink-600 scale-0 transition-transform duration-500 ease-out origin-center group-hover:scale-100"></span>
            <FaLinkedinIn className="relative text-gray-400 text-lg transition-all duration-300 group-hover:text-white group-hover:scale-125" />
          </a>
          <a
          ...
          >
            <span className="absolute inset-0 rounded-full bg-pink-600 scale-0 transition-transform duration-500 ease-out origin-center group-hover:scale-100"></span>
            <FaWhatsapp className="relative text-gray-400 text-lg transition-all duration-300 group-hover:text-white group-hover:scale-125" />
          </a>
        </div>
