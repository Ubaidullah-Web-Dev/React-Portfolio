        ...
        <section className="bg-white dark:bg-black text-black dark:text-white py-20 md:py-28 overflow-hidden transition-colors duration-500">
            <div className="container mx-auto px-6">
                <div data-aos="fade-left" data-aos-delay="100" className="text-center mb-16">
                    <p className="text-pink-600 uppercase font-semibold tracking-widest text-sm mb-2">{eduandexp.caption}</p>
                    <h2 className="text-3xl md:text-5xl font-extrabold mb-4">{eduandexp.title}
                    </h2>
                    <p className="text-gray-700 dark:text-gray-400 max-w-2xl mx-auto text-sm md:text-base">{eduandexp.description}</p>
                </div>
